...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-1761-dense-rational-distance-sets-in-the-pl-38280000-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-1761"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-1761-dense-rational-distance-sets-in-the-pl-38280000-v1",
      "problem_contract_sha256": "5bc85b7481190a6ba8f0e2e09aa9944b883fb2f173181936755fbc8ac3b70de6",
      "problem_id": "problem:um-opg-1761-dense-rational-distance-sets-in-the-pl-38280000",
      "route_id": "route:um-opg-1761-dense-rational-distance-sets-in-the-pl-38280000-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-1761-dense-rational-distance-sets-in-the-pl-38280000-source-fidelity-01",
      "graph_id": "graph:um-opg-1761-dense-rational-distance-sets-in-the-pl-38280000-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-1761-dense-rational-distance-sets-in-the-pl-38280000-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-1761-dense-rational-distance-sets-in-the-pl-38280000-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Problem Does there exist a dense set $S \\subseteq {\\mathbb R}^2$ so that all pairwise distances between points in $S$ are rational?"
          },
          "statement_sha256": "55ff9921e632678a95231695b218c45987eaaf71a897101f8fae9d6d5e2e6ce9"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-1761-dense-rational-distance-sets-in-the-pl-38280000-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-1761-dense-rational-distance-sets-in-the-pl-38280000-root",
      "route_id": "route:um-opg-1761-dense-rational-distance-sets-in-the-pl-38280000-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-1761-2a9a21ea7f4b",
        "url": "https://www.unsolvedmath.com/problems/OPG-1761"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
